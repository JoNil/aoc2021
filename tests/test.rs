...
aoc_test!(test_15b => "2778");
aoc_test!(test_16a => "843");
aoc_test!(test_16b => "5390807940351");
aoc_test!(test_17a => "33670");
aoc_test!(test_17b => "4903");
aoc_test!(test_18a => "4202");
aoc_test!(test_18b => "4779");

aoc_test!(test_20a => "5483");
aoc_test!(test_20b => "18732");
